...
[%header,col=4*]
|===
|icon:envelope[2x] |icon:phone[2x] |icon:map-marker[2x] |icon:linkedin-square[2x]

|mailto:{email}[]
|052-3647491
|Kfar-Saba, Israel 
|link:https://www.linkedin.com/in/eido-tal-bb2692198[Linkedin Profile]
|===
...
** Leading Verification a Data-Path/Packet-Processing Complex for a switch
** Packet-Processing/Data-Path architecture
